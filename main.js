...
$(document).ready(function() {
        ...
        function renderDrink(usedIngredient) {
            var renderIngredient = '<div id="list-of-ingredients">' + usedIngredient + '</div>';
            $('#list-of-ingredients').append(renderIngredient);
        ...
        $('#button').click(function(event) {
                ...
                for (var key in preferences) {
                    ...
                    if (preferences[key]) {
                        var usedIngredient = Pantry[key][Math.floor(Math.random() * 3)];
                        console.log(Drink);
                 renderDrink(usedIngredient);   
                    }
